...
## [0.0.4](https://github.com/GrapeBaBa/kona/compare/kona-derive-v0.0.3...kona-derive-v0.0.4) - 2024-10-03
...
- *(derive)* `BatchStream` buffering ([#590](https://github.com/GrapeBaBa/kona/pull/590))
- *(derive)* BatchStreamProvider ([#591](https://github.com/GrapeBaBa/kona/pull/591))
- *(derive)* Refactor out Online Providers ([#569](https://github.com/GrapeBaBa/kona/pull/569))
- *(derive)* interleaved channel tests ([#585](https://github.com/GrapeBaBa/kona/pull/585))
- *(derive)* Holocene Buffer Flushing ([#575](https://github.com/GrapeBaBa/kona/pull/575))
- *(derive)* Holocene Channel Bank Checks ([#572](https://github.com/GrapeBaBa/kona/pull/572))
- *(derive)* Holocene Frame Queue ([#579](https://github.com/GrapeBaBa/kona/pull/579))
- *(derive)* Holocene Activation ([#574](https://github.com/GrapeBaBa/kona/pull/574))
- *(derive)* wire up the batch span stage ([#567](https://github.com/GrapeBaBa/kona/pull/567))
- *(derive)* New BatchStream Stage for Holocene ([#566](https://github.com/GrapeBaBa/kona/pull/566))
- *(derive)* Hoist AttributesBuilder ([#571](https://github.com/GrapeBaBa/kona/pull/571))
- *(derive)* Touchup Docs ([#555](https://github.com/GrapeBaBa/kona/pull/555))
- *(derive)* Latest BN ([#521](https://github.com/GrapeBaBa/kona/pull/521))
- Remove L2 Execution Payload ([#542](https://github.com/GrapeBaBa/kona/pull/542))
- *(derive)* Typed error handling ([#540](https://github.com/GrapeBaBa/kona/pull/540))
...
- *(primitives)* reuse op-alloy-protocol channel and block types ([#499](https://github.com/GrapeBaBa/kona/pull/499))

### Fixed

- derive pipeline params ([#587](https://github.com/GrapeBaBa/kona/pull/587))
- *(workspace)* hoist and fix lints ([#577](https://github.com/GrapeBaBa/kona/pull/577))
- *(derive)* move attributes builder trait ([#570](https://github.com/GrapeBaBa/kona/pull/570))
- *(client)* Channel reader error handling ([#539](https://github.com/GrapeBaBa/kona/pull/539))
- *(derive)* Sequence window expiry ([#532](https://github.com/GrapeBaBa/kona/pull/532))
- *(primitives)* use consensus hardforks ([#497](https://github.com/GrapeBaBa/kona/pull/497))
- *(primitives)* re-use op-alloy frame type ([#492](https://github.com/GrapeBaBa/kona/pull/492))

### Other

- use alloy primitives map ([#586](https://github.com/GrapeBaBa/kona/pull/586))
- *(derive)* [Holocene] Drain previous channel in one iteration ([#583](https://github.com/GrapeBaBa/kona/pull/583))
- channel reader docs ([#568](https://github.com/GrapeBaBa/kona/pull/568))
